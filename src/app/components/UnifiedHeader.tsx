// src/app/components/UnifiedHeader.tsx - Updated with consistent credits display and removed admin tags
'use client';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center items-center h-16">
              ...
              <div className="flex items-center space-x-2 text-xl font-bold text-indigo-600">
                <Image
                    src="/tabicon.ico"
                    alt="Smarty Logo Generator Logo"
                    width={64}
                    height={64}
                    className="rounded"
                />
                <span>Smarty Logo Generator</span>
              </div>
            </div>
          </div>
        </header>
            ...
            <div className="flex items-center justify-between h-12 pt-2">
              ...
              >
                <Image
                    ...
                    className="rounded"
                />
                <span className="text-sm">Smarty Logo Generator</span>
              </Link>
