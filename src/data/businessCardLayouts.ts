...
// INSTRUCTIONS: Surgically replace only these 5 layout objects in the BUSINESS_CARD_LAYOUTS array

    {
        ...
        theme: 'trendy',
        description: 'Bold brutalist design with strong typography and high contrast',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
  ...
  ">
    ...
    ">
      ...
      ">
        ...
        <div class="bc-contact-email" data-email-type="primary" style="font-size: 9px;">✉️ alex@stone.design</div>
      </div>
      <div class="logo-placeholder" style="
        width: 0.6in;
        height: 0.6in;
...

    {
        ...
        theme: 'professional',
        description: 'Clean medical professional design with trust elements and credentials',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
...
">
  ...
  <div style="padding: 0.25in;">
    ...
    <div class="bc-contact-subtitle" style="
      font-size: 9px;
      color: #64748b;
      margin: 0 0 12px 0;
      font-style: italic;
    ">Board Certified • MD, Johns Hopkins</div>
    <div style="
      display: grid;
      grid-template-columns: 1fr 1fr;
      gap: 10px;
    ...
    ">
      <div>
        <div class="bc-contact-phone" data-phone-type="office" style="margin-bottom: 3px;">☎️ (555) 123-4567</div>
        <div class="bc-contact-phone" data-phone-type="fax" style="margin-bottom: 3px;">📠 (555) 123-4568</div>
        <div class="bc-contact-email" data-email-type="primary">✉️ s.mitchell@healthplus.com</div>
      </div>
      <div style="text-align: right;">
        <div style="margin-bottom: 3px;">🏥 123 Medical Center Dr</div>
        <div style="margin-bottom: 3px;">Boston, MA 02101</div>
        <div class="bc-contact-website">🌐 healthcareplus.com</div>
      </div>
    </div>
  </div>
</div>`,
        metadata: {
            ...
            fonts: ['Helvetica'],
            features: ['medical', 'professional', 'clean-design', 'trust-elements', 'credentials-display']
        }
    },
...
// INSTRUCTIONS: Replace only the BC014 layout object in the array

    {
        ...
        theme: 'vintage',
        description: 'Classic letterpress-inspired design with vintage typography and aged aesthetic',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
  ...
  ">
    ...
    <div class="footer-section" style="margin-top: auto;">
      ...
      <div class="bc-contact-info-block" style="
        ...
        line-height: 1.4;
      ">
        <div class="bc-contact-phone" data-phone-type="office" style="margin-bottom: 2px;">☎️ (555) 123-4567</div>
        <div class="bc-contact-email" data-email-type="primary" style="margin-bottom: 2px;">✉️ info@pembertonco.com</div>
        <div class="bc-contact-website">🌐 pembertonco.com</div>
      </div>
    </div>
  </div>
</div>`,
        metadata: {
            ...
            colors: ['#f4e4bc', '#8b4513', '#5d4037'],
            fonts: ['Georgia'],
            features: ['vintage', 'letterpress-style', 'aged-effects', 'craftsmanship', 'centered-layout']
        }
    },

    {
        ...
        theme: 'artistic',
        description: 'Vibrant watercolor splash with artistic typography and playful design',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
...
">
  ...
  ">
    ...
    ">
      <div style="flex: 1;">
        ...
        <h3 class="bc-contact-company" style="
          ...
          margin: 0 0 8px 0;
          font-weight: 500;
        ">Colorful Creations Studio</h3>
      </div>
      <div class="logo-placeholder" style="
        width: 0.7in;
        height: 0.7in;
        background: linear-gradient(135deg, rgba(255, 107, 107, 0.2), rgba(72, 187, 120, 0.2));
        border-radius: 50%;
    ...
    ">
      <div class="bc-contact-phone" data-phone-type="mobile" style="margin-bottom: 2px;">📱 (555) 123-4567</div>
      <div class="bc-contact-email" data-email-type="primary" style="margin-bottom: 2px;">✉️ maya@colorfulcreations.art</div>
      <div class="bc-contact-website">🎨 colorfulcreations.art</div>
    </div>
  </div>
</div>`,
        metadata: {
  ...
  <div style="padding: 0.16in; position: relative; z-index: 2; height: 100%;">
    ...
    ">
      ...
      <div>
        ...
        ">
          <div class="bc-contact-phone" data-phone-type="mobile" style="margin-bottom: 2px;">📱 (555) 123-4567</div>
          <div class="bc-contact-email" data-email-type="primary">✉️ jake@boldcreative.studio</div>
        </div>
      </div>
    </div>
  </div>
    ...
    {
        catalogId: 'BC022',
        name: 'Asymmetric Angles - Warm',
        theme: 'modern',
        description: 'Modern asymmetric design with warm angular color blocks and diagonal emphasis',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
  ...
  overflow: hidden;
">
  <!-- Angular Color Block 1 - Top Left (Warm Orange) -->
  <div style="
    position: absolute;
    top: 0;
    left: 0;
  ...
  <!-- Angular Color Block 2 - Bottom Right (Amber) -->
  <div style="
    position: absolute;
    bottom: 0;
    right: 0;
  ...
  <div style="padding: 0.3in; position: relative; z-index: 2; height: 100%;">
    ...
    ">
      ...
      <div style="flex: 1; max-width: 55%; display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
        <div>
          <h1 class="bc-contact-name" style="
            font-size: 16px;
            font-weight: 700;
...
">
  ...
  <div style="padding: 0.25in; position: relative; z-index: 2; height: 100%; display: flex; flex-direction: column;">
    ...
    <div style="margin-top: auto;">
      ...
      ">
        <div class="bc-contact-phone" data-phone-type="mobile" style="margin-bottom: 2px;">📱 (555) 123-4567</div>
        <div class="bc-contact-email" data-email-type="primary" style="margin-bottom: 2px;">✉️ sofia@digitalinnovations.com</div>
        <div class="bc-contact-website">🌐 digitalinnovations.com</div>
      </div>
    </div>
  </div>
</div>`,
...

    {
        ...
        theme: 'artistic',
        description: 'Dynamic ink splash design with artistic flair and social media',
        style: 'contact-focused',
        jsx: `<div class="business-card" style="
  width: 3.5in;
  height: 2in;
...
">
  ...
  <div style="padding: 0.4in; position: relative; z-index: 2;">
    ...
    {
        catalogId: 'BC026',
        name: 'Asymmetric Angles',
        theme: 'modern',
        description: 'Modern asymmetric design with angular color blocks',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
  ...
  <div style="padding: 0.3in; position: relative; z-index: 2; height: 100%;">
    ...
    ">
      ...
      <div style="flex: 1; max-width: 55%; display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
        ...
        ">
          <div class="bc-contact-phone" data-phone-type="mobile" style="margin-bottom: 3px;">📱 (555) 123-4567</div>
          <div class="bc-contact-email" data-email-type="primary" style="margin-bottom: 3px;">✉️ ryan@asymmetric.design</div>
          <div class="bc-contact-website">🌐 asymmetric.design</div>
        </div>
      </div>
...
<div class="business-card" style="
  ...
  overflow: hidden;
">
  <!-- Collage Element 1: Yellow Rectangle -->
  <div style="
    position: absolute;
    top: 10px;
    left: 15px;
  ...
  <!-- Collage Element 3: Green Rectangle -->
  <div style="
    position: absolute;
    bottom: 15px;
    left: 30px;
  ...
  <!-- Collage Element 4: Purple Square -->
  <div style="
    position: absolute;
    bottom: 20px;
    right: 15px;
  ...
  <div style="padding: 0.3in; position: relative; z-index: 2;">
    ...
    ">
      ...
      ">
        ...
        <div class="bc-contact-info-block" style="
          ...
          line-height: 1.4;
        ">
          <div class="bc-contact-email" data-email-type="primary" style="margin-bottom: 2px;">🎨 mia@collagecanvas.art</div>
          <div class="bc-contact-phone" data-phone-type="mobile" style="margin-bottom: 2px;">📱 (555) 123-4567</div>
          <div class="bc-contact-social">✨ @miacollages</div>
        </div>
...

    {
        ...
        name: 'Data Flow Tech',
        theme: 'tech',
        description: 'Clean tech design with data flow elements and location',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
...
">
  ...
  <div style="padding: 0.25in;">
    ...
    <div style="
      ...
      color: #475569;
    ">
      <div class="bc-contact-info-block">
        <div class="bc-contact-phone" data-phone-type="mobile" style="margin-bottom: 3px;">📞 (555) 123-4567</div>
        <div class="bc-contact-email" data-email-type="primary">✉️ david@dataflow.tech</div>
      </div>
      <div style="text-align: right;">
        <div class="bc-contact-website" style="margin-bottom: 3px;">🌐 dataflow.tech</div>
        <div class="bc-contact-address">📍 San Francisco, CA</div>
      </div>
    </div>
  </div>
</div>`,
  ...
  <div style="padding: 0.25in; position: relative; z-index: 2; height: 100%;">
    ...
    ">
      ...
      <div style="flex: 1; max-width: 1.8in;">
        ...
        <!-- Bracket-Style Contact Block (NO EMOJIS) -->
        <div class="bc-contact-info-block" style="
          font-size: 9px;
          color: #f1f5f9;
          line-height: 1.4;
          font-family: 'Roboto Mono', monospace;
        ">
          <div class="bc-contact-phone" data-phone-type="mobile" style="margin-bottom: 2px;">[MOBILE] (555) 123-4567</div>
          <div class="bc-contact-email" data-email-type="primary" style="margin-bottom: 2px;">[EMAIL] alex@circuitflow.tech</div>
          <div class="bc-contact-website">[WEB] circuitflow.tech</div>
        </div>
      </div>
...

    {
        ...
        theme: 'luxury',
        description: 'Elegant monogram design with classic typography and double border',
        style: 'contact-focused',
        jsx: `
<div class="business-card" style="
  width: 3.5in;
    ...
    ">
      ...
      <div style="flex: 1; max-width: 1.8in;">
        ...
        <div class="bc-contact-info-block" style="
          ...
          line-height: 1.5;
        ">
          <div class="bc-contact-phone" data-phone-type="direct" style="margin-bottom: 3px;">📞 (555) 123-4567</div>
          <div class="bc-contact-email" data-email-type="primary" style="margin-bottom: 3px;">✉️ elizabeth@morganassoc.com</div>
          <div class="bc-contact-website">🌐 morganassoc.com</div>
        </div>
      </div>
...
">
  <div style="padding: 0.25in; position: relative; z-index: 2; height: 100%;">
    ...
    {
        catalogId: 'BC036',
        name: 'Bold Creative Splash - Cool',
        theme: 'creative',
